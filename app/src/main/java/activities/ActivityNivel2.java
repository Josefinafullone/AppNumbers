...
public class ActivityNivel2 extends AppCompatActivity implements ActivityNivel {

    private TextView tv_nombre, tv_puntaje, tv_respuesta;
    private ImageView iv_valoruno, iv_valordos, iv_vidas;
    private EditText et_respuesta;

    private static int MAX_SCORE = 19;
    private static String[] OPERACIONES_DISPONIBLES = {"suma"};
    ...
    public void iniciarActividadSiguiente() {
        ...
        Intent intent = new Intent(this, ActivityNivel3.class);
