...
public class ActivityNivel4 extends AppCompatActivity implements ActivityNivel {
    ...
    public void iniciarActividadSiguiente() {
        ...
        Intent intent = new Intent(this, ActivityNivel5.class);
