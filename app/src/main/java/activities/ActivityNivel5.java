...
public class ActivityNivel5 extends AppCompatActivity implements ActivityNivel {
    ...
    public void iniciarActividadSiguiente() {
        ...
        Intent intent = new Intent(this, ActivityNivel6.class);
