...
public class ActivityNivel3 extends AppCompatActivity implements ActivityNivel {

    private TextView tv_nombre, tv_puntaje, tv_respuesta;
    private ImageView iv_valoruno, iv_valordos, iv_vidas;
    private EditText et_respuesta;

    private static int MAX_SCORE = 29;
    ...
    public void iniciarActividadSiguiente() {
        ...
        Intent intent = new Intent(this, ActivityNivel4.class);
